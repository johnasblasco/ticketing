...
<body>
   ...
   <?php include_once('includes/sidebar.php');?>
        ...
        <div class="content">            
            ...
            <div class="mainDashboard container text-center ">
            <h2 class="text-primary">Available Slots</h2>
...
$count_total_vehentries=mysqli_num_rows($query3);
 ?>
    ...
    <script>
        ...
        function updateVehicleCount(vehicleType) {
            var countElement = document.getElementById(vehicleType + "Count");
            var countText = countElement.innerText;
            var count = parseInt(countText.split('/')[0]);
            count++;
            countElement.innerText = count + "/50";
        }
